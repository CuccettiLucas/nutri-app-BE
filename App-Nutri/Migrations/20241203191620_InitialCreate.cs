    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlimentoPaciente", x => new { x.AlimentoId, x.PacienteId });
                    table.ForeignKey(
                        name: "FK_AlimentoPaciente_Alimentos_AlimentoId",
                        column: x => x.AlimentoId,
                        principalTable: "Alimentos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlimentoPaciente_Pacientes_PacienteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlimentoPaciente_PacienteId",
                table: "AlimentoPaciente",
                column: "PacienteId");
        }
