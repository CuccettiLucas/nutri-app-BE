...
namespace App_Nutri.Migrations
{
    ...
    [Migration("20250717185255_UpdateSubCategoriaPersonalizada")]
    partial class UpdateSubCategoriaPersonalizada
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App_Nutri.Models.SubCategoria", b =>
                {
                    ...
                    b.Property<double>("PorcionGramos")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("App_Nutri.Models.SubCategoriaPacientePersonalizada", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SubCategoriaPacientePersonalizadas");
                });
            ...
            modelBuilder.Entity("App_Nutri.Models.SubCategoriaPacientePersonalizada", b =>
                {
                    b.HasOne("App_Nutri.Models.PacienteListaPersonalizada", "PacienteListaPersonalizada")
                        .WithMany("SubCategoriasPersonalizadas")
                        .HasForeignKey("PacienteListaPersonalizadaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("App_Nutri.Models.SubCategoria", "SubCategoria")
                        .WithMany()
                        .HasForeignKey("SubCategoriaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("App_Nutri.Models.PacienteListaPersonalizada", b =>
                {
                    ...
                    b.Navigation("SubCategoriasPersonalizadas");
                });
